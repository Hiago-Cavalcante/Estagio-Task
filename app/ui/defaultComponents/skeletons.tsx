  ...
  return (
    <tr className="w-full border-b border-gray-100 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <td className="px-3 py-3">
        <div className="h-6 w-64 max-w-[24rem] rounded bg-gray-100" />
      </td>
      {/* Status */}
      <td className="whitespace-nowrap px-3 py-3">
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4">
      ...
      <div className="flex items-center justify-between pt-4">
        ...
        <div className="ml-3 h-6 w-16 rounded-full bg-gray-100" />
      </div>
    </div>
  )
}
...
export function ProductTableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className={`rounded-lg bg-gray-50 p-2 md:pt-0 ${shimmer}`}>
          <div className="md:hidden">
...
export function ProductsChartSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-xl bg-gray-50 p-4`}
    >
      <div className="mb-4 h-6 w-48 rounded-md bg-gray-200" />
      <div className="h-[400px] md:h-[500px] rounded-md bg-gray-200" />
    </div>
  )
}
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <div className="rounded-lg bg-gray-200 p-4 h-20" />
        <div className="rounded-lg bg-gray-200 p-4 h-20" />
        <div className="rounded-lg bg-gray-200 p-4 h-20" />
      </div>
    </div>
  ...
  return (
    <div className={`${shimmer} relative flex w-full flex-col overflow-hidden`}>
      ...
      <div className="flex flex-col gap-4">
        {/* Most Expensive Skeleton */}
        <div className="rounded-xl bg-gray-50 p-4">
          <div className="flex items-center gap-2 mb-3">
            <div className="h-5 w-5 rounded-full bg-gray-200" />
            <div className="h-5 w-32 rounded-md bg-gray-200" />
          </div>
          <div className="bg-white px-4 rounded-lg py-2">
            ...
            <div className="py-3 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="mt-1 h-4 w-20 rounded-md bg-gray-200" />
                </div>
                <div className="h-5 w-20 rounded-md bg-gray-200" />
              </div>
            </div>
            <div className="py-3 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="mt-1 h-4 w-28 rounded-md bg-gray-200" />
                </div>
                <div className="h-5 w-20 rounded-md bg-gray-200" />
              </div>
            </div>
